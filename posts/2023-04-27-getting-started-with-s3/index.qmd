...
## Start MinIO docker instance
```{.bash filename="Run docker instance"}
...
```{.bash filename="Install boto3 library"}
pip install boto3
```
...
s3client.download_file(
    ...
    Key="data/star_pattern_turtlesim.png",
    Filename="downloaded_turtlesim.jpg",
)
```
